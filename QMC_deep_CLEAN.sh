...
# DONE -> .htaccess files
echo ""
echo "Doing a system prune ALL"
yes Y |docker system prune -a
echo "[Done -> docker system prune ]"
echo ""
echo "Remove instacraft repo"
yes Y |rm -r instacraft 
echo "[Done -> Remove instacraft repo ]"
echo ""
echo "Remove instacraft-med repo"
yes Y |rm -r instacraft-med
echo "[Done -> Remove instacraft-med repo ]"
echo ""
echo ""
